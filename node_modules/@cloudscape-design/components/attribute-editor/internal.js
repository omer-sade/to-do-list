...
const InternalAttributeEditor = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement("div", Object.assign({}, baseProps, { ref: mergedRef, className: clsx(baseProps.className, styles.root) }),
        ...
        React.createElement(InternalButton, { className: styles['add-button'], disabled: disableAddButton, 
            ...
            __nativeAttributes: disableAddButton ? { tabIndex: -1 } : {}, __focusable: true, onClick: onAddButtonClick, formAction: "none", ref: addButtonRef, ariaDescribedby: infoAriaDescribedBy }, addButtonText),
