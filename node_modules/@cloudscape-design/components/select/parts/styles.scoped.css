...
.awsui_placeholder_dwuol_etz7p_145:not(#\9) {
  color: var(--color-text-input-placeholder-f3x213, #656871);
  font-style: italic;
}

.awsui_item_dwuol_etz7p_150:not(#\9) {
  display: flex;
  align-items: center;
}
.awsui_item_dwuol_etz7p_150 > .awsui_checkbox_dwuol_etz7p_154:not(#\9) {
  position: relative;
...
.awsui_filter_dwuol_etz7p_163:not(#\9) {
  z-index: 4;
  flex-shrink: 0;
}

.awsui_trigger_dwuol_etz7p_168:not(#\9) {
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
}

.awsui_layout-strut_dwuol_etz7p_174:not(#\9) {
  inline-size: 100%;
  position: relative;
  transform: translate3d(0, 0, 0);
}

.awsui_list-bottom_dwuol_etz7p_180:not(#\9) {
  /* used in unit-tests */
}

.awsui_selected-icon_dwuol_etz7p_184:not(#\9) {
  color: var(--color-border-item-focused-nv6mhz, #006ce0);
}

.awsui_show-label-tag_dwuol_etz7p_188 > .awsui_selected-icon_dwuol_etz7p_184:not(#\9) {
  padding-inline-start: var(--space-scaled-s-aqzyko, 12px);
}

.awsui_inline-token-trigger_dwuol_etz7p_192:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
...
.awsui_inline-token-list_dwuol_etz7p_199:not(#\9) {
  display: flex;
  flex-wrap: nowrap;
  align-items: center;
...
.awsui_inline-token-list_dwuol_etz7p_199:not(#\9):dir(rtl) {
  -webkit-mask-image: linear-gradient(-270deg, transparent, white 20px, white);
          mask-image: linear-gradient(-270deg, transparent, white 20px, white);
}
.awsui_inline-token-list_dwuol_etz7p_199 > .awsui_inline-token_dwuol_etz7p_192:not(#\9) {
  display: flex;
  align-items: center;
...
.awsui_visual-refresh_dwuol_etz7p_229 > .awsui_inline-token-list_dwuol_etz7p_199 > .awsui_inline-token_dwuol_etz7p_192:not(#\9) {
...
.awsui_inline-token-hidden-placeholder_dwuol_etz7p_236:not(#\9) {
  position: absolute !important;
  inset-block-start: -9999px !important;
  inset-inline-start: -9999px !important;
}

.awsui_inline-token-counter_dwuol_etz7p_242:not(#\9) {
  white-space: nowrap;
}

.awsui_inline-token-trigger--disabled_dwuol_etz7p_246 > .awsui_inline-token-list_dwuol_etz7p_199 > .awsui_inline-token_dwuol_etz7p_192:not(#\9) {
...
.awsui_inline-label-trigger-wrapper_dwuol_etz7p_252:not(#\9) {
  margin-block-start: -7px;
}

.awsui_inline-label-wrapper_dwuol_etz7p_256:not(#\9) {
  margin-block-start: calc(var(--space-scaled-xs-26e2du, 8px) * -1);
}

.awsui_inline-label_dwuol_etz7p_252:not(#\9) {
...
.awsui_inline-label_dwuol_etz7p_252.awsui_inline-label-disabled_dwuol_etz7p_278:not(#\9) {
...
.awsui_disabled-reason-tooltip_dwuol_etz7p_286:not(#\9) {
